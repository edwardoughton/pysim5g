...
@pytest.mark.parametrize("frequency, distance, ant_height, ant_type, \
    ...
    (3.7,100,10,'micro',5,20,'urban','los',1.5,0,0,42,1,round(86+0.38)),
    (3.7,5000,10,'micro',5,20,'urban','los',1.5,0,1,42,1,round(147.6+0.34)),
    (3.7,100,10,'micro',5,20,'urban','nlos',1.5,0,1,42,1,round(105+0.23)),
    (3.7,5000,10,'micro',5,20,'urban','nlos',1.5,0,1,42,1,round(165+0.27)),
