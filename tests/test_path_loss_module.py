...
@pytest.mark.parametrize("frequency, distance, ant_height, ue_height, \
    ...
    (1.8,1000,20,1.5,42,1,round(97.51+0.48,2)),
    # (1.8,2000,20,1.5,42,1,round(103.53+0.48,2)),
    # (1.8,3000,20,1.5,42,1,round(107.05+0.48,2)),
    # (1.8,4000,20,1.5,42,1,round(109.55+0.48,2)),
    # (1.8,5000,20,1.5,42,1,round(111.48+0.48,2)),
    # (2.6,1000,20,1.5,42,1,round(100.7+0.48,2)),
    # (2.6,2000,20,1.5,42,1,round(106.72+0.48,2)),
    # (2.6,3000,20,1.5,42,1,round(110.24+0.48,2)),
    # (2.6,4000,20,1.5,42,1,round(112.74+0.48,2)),
