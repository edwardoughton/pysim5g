...
def calculate_costs(datum, costs, parameters, site_radius, environment):
    ...
    for strategy in sharing_strategies:
        ...
        output.append({
                ...
                'path_loss': [datum[x]['path_loss'] for x in range(0, len(datum))],
                'received_power': [datum[x]['received_power'] for x in range(0, len(datum))],
                'interference': [datum[x]['interference'] for x in range(0, len(datum))],
                'sinr': [datum[x]['sinr'] for x in range(0, len(datum))],
                'spectral_efficiency': [datum[x]['spectral_efficiency'] for x in range(0, len(datum))],
                'capacity_mbps': [datum[x]['capacity_mbps'] for x in range(0, len(datum))],
                'capacity_mbps_km2': [datum[x]['capacity_mbps'] for x in range(0, len(datum))],
                'strategy': strategy,
